...
static const Key keys[] = {
	...
	{ MODKEY,			                  XF86XK_MonBrightnessUp,    spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +5%") },
	{ MODKEY,			                  XF86XK_MonBrightnessDown,  spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -5%") },
